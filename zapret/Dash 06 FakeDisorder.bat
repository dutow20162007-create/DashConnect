...
--filter-tcp=2053,2083,2087,2096,8443 --hostlist-domains=discord.media --dpi-desync=fake,disorder2 --dpi-desync-split-pos=1 --dpi-desync-repeats=6 --dpi-desync-fooling=badsum --new ^
--filter-tcp=443 --hostlist="%LISTS%list-google.txt" --ip-id=zero --dpi-desync=fake,disorder2 --dpi-desync-split-pos=1 --dpi-desync-repeats=6 --dpi-desync-fooling=badsum --new ^
--filter-tcp=80,443 --hostlist="%LISTS%list-general.txt" --hostlist="%LISTS%list-general-user.txt" --hostlist-exclude="%LISTS%list-exclude.txt" --hostlist-exclude="%LISTS%list-exclude-user.txt" --ipset-exclude="%LISTS%ipset-exclude.txt" --ipset-exclude="%LISTS%ipset-exclude-user.txt" --dpi-desync=fake,disorder2 --dpi-desync-split-pos=1 --dpi-desync-repeats=6 --dpi-desync-fooling=badsum --dpi-desync-fake-http="%BIN%tls_clienthello_max_ru.bin" --new ^
--filter-tcp=80,443 --hostlist-auto="%LISTS%list-auto.txt" --hostlist-exclude="%LISTS%list-exclude.txt" --hostlist-exclude="%LISTS%list-exclude-user.txt" --ipset-exclude="%LISTS%ipset-exclude.txt" --ipset-exclude="%LISTS%ipset-exclude-user.txt" --dpi-desync=fake,disorder2 --dpi-desync-split-pos=1 --dpi-desync-repeats=6 --dpi-desync-fooling=badsum --dpi-desync-fake-http="%BIN%tls_clienthello_max_ru.bin" --new ^
...
--filter-tcp=80,443,8443 --ipset="%LISTS%ipset-all.txt" --hostlist-exclude="%LISTS%list-exclude.txt" --hostlist-exclude="%LISTS%list-exclude-user.txt" --ipset-exclude="%LISTS%ipset-exclude.txt" --ipset-exclude="%LISTS%ipset-exclude-user.txt" --dpi-desync=fake,disorder2 --dpi-desync-split-pos=1 --dpi-desync-repeats=6 --dpi-desync-fooling=badsum --dpi-desync-fake-http="%BIN%tls_clienthello_max_ru.bin" --new ^
